...
from typing import Any, AnyStr, Mapping, TextIO
...
def load(path_or_stream: os.PathLike | str | TextIO,
         base_dir: os.PathLike | AnyStr = None,
         interpret_as_Clipppy=False, force_templating=True,
         scope: Mapping[str, Any] | FrameType = None,
         **kwargs):
